    ...
    <AdminLayout>
        <div class="space-y-6 animate-fade-in max-w-7xl mx-auto w-full p-4 lg:p-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-5">
                    <div class="w-12 h-12 rounded-xl bg-sky-100 dark:bg-sky-900/30 text-sky-600 flex items-center justify-center">
                        <Bolt :size="24" />
                    </div>
                    <div>
                ...
                <div class="flex flex-col lg:flex-row gap-4">
                    <div class="flex-1 relative">
                        ...
                        <input 
                            ...
                            class="w-full px-4 py-2 ps-12 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl font-medium outline-none text-slate-900 dark:text-white focus:ring-2 focus:ring-sky-500/20 transition-all font-medium"
                        >
                    </div>
                    <div class="flex flex-wrap gap-3">
                        <select 
                            v-model="event" 
                            @change="applyFilters"
                            class="px-4 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl font-medium outline-none text-slate-900 dark:text-white focus:ring-2 focus:ring-sky-500/20 transition-all text-sm"
                        >
