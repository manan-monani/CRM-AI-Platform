        ...
        <div class="space-y-6 animate-fade-in max-w-5xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 border-b border-slate-200 dark:border-slate-800 pb-6">
                ...
                <div class="flex items-center gap-3 w-full sm:w-auto">
                    <Link :href="admin.roles.index.url()" class="flex-1 sm:flex-none px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-800 font-bold text-sm text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all text-center">
                        {{ __('Cancel') }}
                    </Link>
                    <button @click="submit" :disabled="form.processing" class="flex-1 sm:flex-none bg-brand-600 text-white px-4 py-2 rounded-xl font-bold text-sm shadow-xl shadow-brand-600/20 hover:bg-brand-700 transition-all disabled:opacity-50">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-4 space-y-6">
                    <div class="bg-white dark:bg-slate-800 p-5 rounded-xl border border-slate-200/60 dark:border-slate-700 shadow-sm">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea v-model="form.description" rows="3" :placeholder="__('e.g. Can manage all system settings')" class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl font-medium outline-none transition-all focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 resize-none text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500"></textarea>
                ...
                <div class="lg:col-span-8 space-y-8">
                    <div v-for="(module, moduleKey) in permissions" :key="moduleKey" class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200/60 dark:border-slate-700 shadow-sm overflow-hidden">
