    ...
    <AdminLayout>
        <div class="space-y-6 animate-fade-in">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-start">
                ...
                <Link :href="admin.users.create ? admin.users.create.url() : '#'" class="bg-brand-600 hover:bg-brand-700 text-white px-6 py-3 rounded-xl font-bold text-sm shadow-xl shadow-brand-600/20 flex items-center transition-all active:scale-95">
                            ...
                            <tr v-for="user in users.data" :key="user.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-all duration-200 group">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-4">
                                        <UserAvatar :user="user" size="md" class="rounded-xl" />
                                        <div>
