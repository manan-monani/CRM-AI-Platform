...
<template>
    <header class="h-16 flex items-center justify-between px-4 lg:px-6 bg-admin-header dark:bg-admin-header-dark backdrop-blur-md border-b border-admin-sidebar-border dark:border-admin-sidebar-border-dark sticky top-0 z-40 transition-colors duration-300">
        ...
        <div class="flex items-center gap-2 md:gap-4 relative">
            <NotificationBell
                ...
                :delete-url="(id) => admin.notifications.destroy.url({ id })"
            />
            ...
            <button 
                ...
                class="hidden md:flex bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-3 py-1.5 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all items-center shadow-sm disabled:opacity-50 disabled:cursor-not-allowed" 
                :title="__('Refresh')"
            >
                 <svg 
            ...
            <div class="relative inline-block text-start ms-2" ref="dropdownRef">
                ...
                <!-- Dropdown -->
                <div v-show="isUserDropdownOpen" class="absolute end-0 mt-3 w-56 bg-white dark:bg-slate-900 rounded-xl shadow-2xl border border-slate-100 dark:border-slate-800 py-2 z-50 dropdown-animate origin-top-right">
                    ...
                    <div class="p-1">
                        <Link :href="admin.profile.edit.url()" class="w-full flex items-center space-x-3 rtl:space-x-reverse px-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-sky-600 dark:hover:text-sky-400 rounded-xl transition-all font-medium text-start">
